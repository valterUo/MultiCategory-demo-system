...
class SimpleDemoDataQueryTest {
	...
	void testQuery1() {
		...
		assertEquals(answer.replaceAll("\\s{1,}", " ").trim(), selectiveQuery.getHaskellCode().replaceAll("\\s{1,}", " ").trim(), "Simple query test 1");
	}
	...
	void testQuery2() {
		...
		assertEquals(answer.replaceAll("\\s{1,}", " ").trim(), selectiveQuery.getHaskellCode().replaceAll("\\s{1,}", " ").trim(), "Simple query test 2");
	}
	...
	void testQuery3() {
		...
		assertEquals(answer.replaceAll("\\s{1,}", " ").trim(), selectiveQuery.getHaskellCode().replaceAll("\\s{1,}", " ").trim(), "Simple query test 3");
	}
	...
	void testQuery4() {
		...
		assertEquals(answer.replaceAll("\\s{1,}", " ").trim(), selectiveQuery.getHaskellCode().replaceAll("\\s{1,}", " ").trim(), "Simple query test 4");
	}
	...
	void testQuery5() {
		...
		assertEquals(answer.replaceAll("\\s{1,}", " ").trim(), selectiveQuery.getHaskellCode().replaceAll("\\s{1,}", " ").trim(), "Simple query test 5");
	}
	...
	void testQuery6() {
		...
		assertEquals(answer.replaceAll("\\s{1,}", " ").trim(), selectiveQuery.getHaskellCode().replaceAll("\\s{1,}", " ").trim(), "Simple query test 6");
	}
	...
	void testQuery7() {
		...
		assertEquals(answer.replaceAll("\\s{1,}", " ").trim(), selectiveQuery.getHaskellCode().replaceAll("\\s{1,}", " ").trim(), "Simple query test 7");
	}
	...
	void testQuery8() {
		...
		assertEquals(answer.replaceAll("\\s{1,}", " ").trim(), selectiveQuery.getHaskellCode().replaceAll("\\s{1,}", " ").trim(), "Simple query test 8");
	}
	...
	void testQuery9() {
		...
		assertEquals(answer.replaceAll("\\s{1,}", " ").trim(), selectiveQuery.getHaskellCode().replaceAll("\\s{1,}", " ").trim(), "Simple query test 9");
	}
